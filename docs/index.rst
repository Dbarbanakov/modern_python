...
using the `JSON Placeholder API <https://jsonplaceholder.typicode.com/>`_.
...
.. option:: --endpoint <endpoint>
   ...
   `jsonplaceholder - <https://jsonplaceholder.typicode.com/>`_.
   By default, "todos" endpoint is reached.
